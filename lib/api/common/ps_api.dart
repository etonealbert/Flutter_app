...
abstract class PsApi {
  ...
  void printGetLog(PsApiResponse psApiResponse, http.Response response) {
    ...
    print('\u001b[33m ${response.statusCode} ${psApiResponse.isSuccessful() ? success : failed} <-- ${response.request?.url.toString()}\u001b[0m');
    print('____________________________________________________________________________________________');
    print('');
  }
  ...
  void printPostLog(PsApiResponse psApiResponse, http.Response response,
    ...
    const String failed = '❌';
    print('____________________________________________________________________________________________');
    print('\u001b[33m POST   --> ${response.request?.url.toString()}\u001b[0m ');
