...
class _CommentListViewState extends State<CommentListView>
  ...
  late PsValueHolder _psValueHolder;
  bool _showAds = false;
  ...
  Widget build(BuildContext context) {
    ...
    if (_psValueHolder.isShowAdmob != null &&
        _psValueHolder.isShowAdmob == PsConst.ONE) {
      _showAds = true;
    } else {
      _showAds = false;
    }
      ...
      child: PsWidgetWithAppBar<CommentHeaderProvider>(
        ...
        initProvider: () {
          return CommentHeaderProvider(
              repo: commentHeaderRepo!, psValueHolder: _psValueHolder);
        },
