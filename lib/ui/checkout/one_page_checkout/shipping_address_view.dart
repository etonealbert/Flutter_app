...
class ShippingAddressView extends StatefulWidget {
  ...
  @override
  @override
  __ShippingAddressViewState createState() => __ShippingAddressViewState();
}

class __ShippingAddressViewState extends State<ShippingAddressView>
                    ...
                    if (emailController.text == '' ||
                      ...
                      showDialog<dynamic>(
                          ...
                          builder: (BuildContext context) {
                            return ErrorDialog(
                              message:
                                  Utils.getString(context, 'warning_dialog__shipping_email'),
                            );
                          });
                          ...
                          builder: (BuildContext context) {
                            return ErrorDialog(
                              message: Utils.getString(
                                  context, 'Please input shipping phone number'),
                            );
                          });
          ...
          child: Container(
            ...
            child:
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: <
                    Widget>[
              const _ShippingAddressTextWidget(),
              const SizedBox(
                  ...
                  onTap: () async {
                    ...
                    if (result != null && result is ShippingCountry) {
                      setState(() {
                        ...
                        cityController.text = '';
                        widget.userProvider.user.data?.country?.id = result.id;
                    ...
                    if (countryController.text.isEmpty) {
                      ...
                      if (result != null && result is ShippingCity) {
                        setState(() {
                          ...
                          widget.userProvider.user.data?.city?.id = result.id;
                        });
                      }
                    }
                  }),
...
class _ShippingAddressTextWidget extends StatelessWidget {
  const _ShippingAddressTextWidget();
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          Text(
            Utils.getString(context, 'checkout_one_page__shipping_address'),
