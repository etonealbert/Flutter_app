...
class Basket extends PsObject<Basket> {
  ...
  Basket fromMap(dynamic dynamicData) {
   // if (dynamicData != null) {
      return Basket(
        ...
        selectedAttributeTotalPrice: dynamicData['selected_attribute_total_price'],
        product: Product().fromMap(dynamicData['product']),
        basketSelectedAttributeList: BasketSelectedAttribute().fromMapList(dynamicData['basket_selected_attribute']),
      );
    // } else {
    //   return null;
    // }
  ...
  Map<String, dynamic>? toMap(Basket? object) {
    if (object != null) {
      ...
      data['selected_attribute_total_price'] = object.selectedAttributeTotalPrice;
      data['product'] = Product().toMap(object.product);
      data['basket_selected_attribute'] = BasketSelectedAttribute().toMapList(object.basketSelectedAttributeList!);
      return data;
    } else {
      return null;
    }
