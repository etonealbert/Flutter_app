...
class PsConfig {
  ...
  ///
  static const String app_version = '2.7.0';
  ...
  ///
  static const String ps_base_url = 'https://www.products.panacea-soft.co/flutter-store-admin-demo';
...
// static const ps_language_list = [Locale('en', 'US'), Locale('ar', 'DZ')];
  ...
  ///Home Slider Setting
  ///
  // static bool showBestChoiceSlider = true;
  ...
  // static String flutterWaveTxref = 'My_unique_transaction_reference_123';
